...
class BlogPost(db.Model):
    __tablename__ = "blog_posts" #child table
    ...
    #make a one to many relationship between blogposts and comments
...
class RegisteredUsers(db.Model, UserMixin):
    __tablename__="registered_users" #parent table
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
...
class Comment(db.Model):
    ...
    author_id: Mapped[int] = mapped_column(Integer, db.ForeignKey("registered_users.id"))
    comment_author = relationship("RegisteredUsers", back_populates="comments")
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        login_user(new_entry)  # creates a session
